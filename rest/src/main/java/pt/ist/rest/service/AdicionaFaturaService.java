...
public class AdicionaFaturaService extends RestService {
	...
	public AdicionaFaturaService(ClienteDto cliente, Serie serie, int sequencia,int nifEmissor) {
		...
		this.fatura.setNifEmissor(nifEmissor);
		this.fatura.setNomeEmissor("portal");
	}

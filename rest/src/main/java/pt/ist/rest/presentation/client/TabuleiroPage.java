<<<<<<< HEAD:rest/src/main/java/pt/ist/rest/presentation/client/TabuleiroPage.java
...
public class AlterarQuantidadePage extends Composite{
		...
		private final AlterarQuantidadePanel alterarQuantidadePanel;
		
		public AlterarQuantidadePage(final RestGWT rootPage, final RestServletAsync rpcService) {				
			this.rpcService = rpcService;
			this.rootPage = rootPage;

			alterarQuantidadePanel = new AlterarQuantidadePanel(rootPage, rpcService);
			...
			refreshButton.addClickHandler(new ClickHandler() {
				@Override
				public void onClick(ClickEvent event) {
					rootPage.showAlterarQuantidade(loggedPerson);
				}
			});
			logOutButton.addClickHandler(new ClickHandler() {
	            @Override
...
>>>>>>> eb3ccbf757964cbe4a4b17d95d799ab3eeb5e2d9:rest/src/main/java/pt/ist/rest/presentation/client/TabuleiroPage.java

...
public class ProcurarPratoPorNomeTest extends RestServiceTestCase{
	 ...
	 @Override
		...
		adicionaPrato(EXISTING_RESTAURANT_NAME, EXISTING_DISH_NAME, 12, 89, 0);
	    }

	 public void testProcuraPratoExistente() {
			
			PratoDto dto = new PratoDto(EXISTING_DISH_NAME,80,12,2);
			RestauranteSimpleDto restauranteSimpleDto = new RestauranteSimpleDto(EXISTING_RESTAURANT_NAME,EXISTING_RESTAURANT_ADDRESS,2);

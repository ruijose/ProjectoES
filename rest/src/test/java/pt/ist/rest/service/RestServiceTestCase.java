...
public abstract class RestServiceTestCase extends TestCase {
	...
	@Atomic
	protected void adicionaCliente(String nomeCli,String morada,String user,String mail,String pass) {
		Rest rest = FenixFramework.getRoot();
		rest.addCliente(new Cliente(nomeCli,morada,user,mail,pass));
	}
